...
export default function UserDashboard() {
  ...
  const columns: Column[] = [
    ...
    { id: "Received", label: "Received", minWidth: 100, align: "center" },
  ...
  return (
    <div className="flex flex-col bg-form-background lg:pt-[20px] lg:pb-[27px] lg:w-[850px] lg:px-[20px] rounded-[20px]">
      {/* Search Input */}
      <Input
        placeholder="Search..."
      ...
      />
      <div className="lg:mt-[41px] lg:mb-[22px]">
